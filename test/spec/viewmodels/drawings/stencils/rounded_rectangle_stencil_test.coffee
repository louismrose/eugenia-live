define [
  ...
  describe 'RoundedRectangleStencil', ->  
    ...
    describe 'translates properties for RoundedRectangle', ->
    ...
    describe 'draw', ->  
      ...
      it 'creates an RoundedRectangle', ->
        path = @draw()
        expect(path.constructor.name).toBe('RoundedRectangle')

      it 'passes properties to RoundedRectangle', ->
