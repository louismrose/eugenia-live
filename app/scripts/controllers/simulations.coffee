define [
  ...
  'models/drawing'
  'views/drawings/simulate'
  'views/drawings/canvas_renderer'
  'controllers/toolbox'
  'controllers/selection'
], (Spine, SubStack, Bacon, Commander, PaletteSpecification, Drawing, SimulateTemplate,CanvasRenderer, Toolbox, Selection) ->
  ...
  class Simulations extends SubStack
    controllers:
      simulate: Simulation
